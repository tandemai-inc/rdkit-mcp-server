...
def register_tools(mcp: FastMCP):
    """Define and register rdkit.Chem.Descriptor tools with the provided FastMCP instance."""
    ...
    # Log this message so that all functions are accessed, and linter doesn't complain
    tool_functions = [
        func.__name__
        for func in [
            exact_mol_wt,
